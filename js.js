const starWarsCharacters = [
  ...
  */
  ...
  for (let i = 0; i < starWarsCharacters.length; i++) {
    const nuovoArray = starWarsCharacters[i];
    const name = nuovoArray.name;
  ...
  */
  ...
  for (let i = 0; i < starWarsCharacters.length; i++) {
    const nuovoArray = starWarsCharacters[i];
    const name = nuovoArray.name;
    if (nuovoArray.gender === "female") {
      // femaleCharacters.push(name);
          femaleCharacters.push(nuovoArray);
    } continue;
  }
  ...
  */
  ...
  for (let i = 0; i < starWarsCharacters.length; i++) {
    const eyeColor1 = starWarsCharacters[i].eye_color;
    switch(eyeColor1){
      case "blue":
